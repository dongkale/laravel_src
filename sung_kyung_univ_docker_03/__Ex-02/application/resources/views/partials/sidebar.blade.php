    ...
    <div class="sidebar-sticky list-group ">
        ...
        <ul class="nav flex-column nav-stacked list-group mt-3">            
            ...
            @if(Auth::user())
                ...
                <li class="nav-item">
                    <a class="nav-link top-menu" href="#menu1-collapse" aria-expanded="{{( $mainMenu == 'SETTING' ) ? 'true' : 'false'}}" data-toggle="collapse">
                        <div class="d-flex w-100 justify-content-start align-items-center">
                            <span class="fa fa-bars"></span>
                            <span class="menu-collapsed">&nbsp;설정</span>
                            <span class="submenu-icon ml-auto"></span>
                        </div>
                    </a>
                    <div>
                        <ul id="menu1-collapse" class="list-unstyled collapse ml-3 {{ ($mainMenu ==  'SETTING') ? 'show' : '' }}">
                            <li class="nav-menu-hover {{ ($subMenu == 'CHANGE_PASSWD') ? 'active' : '' }}">
                                <a class="nav-menu" href="{{ url('/dashboard/setting') }}">&nbsp;암호 변경</a>
                            </li>
                        </ul>
                    </div>
                </li>
